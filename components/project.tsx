...
export default function Project({
  ...
  return (
    ...
    >
      ...
      <section className="text-[#292929] bg-[#e3dfd3] max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-[#f3dbbd] transition sm:group-even:pl-8 ">
